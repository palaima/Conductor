...
public class PagerChild2Controller extends BaseController {
    ...
    public PagerChild2Controller(String title, int backgroundColor, boolean colorIsResId) {
    ...
    public PagerChild2Controller(Bundle args) {
        super(args);
    }
    ...
    protected View inflateView(@NonNull LayoutInflater inflater, @NonNull ViewGroup container) {
        return inflater.inflate(R.layout.controller_pager_child_2, container, false);
    }
